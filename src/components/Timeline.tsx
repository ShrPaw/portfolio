...
const timelineData: TimelineEntry[] = [
  ...
  { year: "2022", title: "Corporate Account Executive", company: "Tigo Bolivia (Millicom)", description: "Managed corporate and SME accounts, closing telecom deals and providing bilingual support at enterprise level.", status: "completed", color: "#22C55E", icon: "📡" },
