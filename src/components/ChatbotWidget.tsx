...
const RESPONSES: Record<string, string> = {
  ...
  languages: "Nicolas is fully bilingual with an official certification:\n\n🇧🇴 Spanish — Native speaker (Bolivia)\n🇺🇸 English — C1 Advanced (EF SET Certified, 63/100, Jan 2026)\n  • Reading: C2 Proficient\n  • Listening: C1 Advanced\n  • Writing: B2 Upper Intermediate\n  • Speaking: B2 Upper Intermediate\n\nHe used English daily in multinational environments (AB InBev, Intcomex) for client communication, technical documentation, and regional team coordination. The EF SET certificate can be viewed on his portfolio site.",
